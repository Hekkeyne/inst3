...
namespace inst3
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            dict1 = new Dictionary<Keys, Action<DataGridView>>
        {
            {Keys.Menu,(x)=>table_schet(x)}
        };
        }
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                dict1[e.KeyCode](dataGridView1);
                MessageBox.Show($"{e.KeyCode} нажата");
            }
            catch
            {
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"{dataGridView2.Rows.Count} {dataGridView2.Columns.Count}Теперь нельзя изменять критерии и альтернативы\n\rНажмите заново, если необходимо что-то изменить");
